...
.. |commits-since| image:: https://img.shields.io/github/commits-since/Ouranosinc/cowbird/0.4.1.svg
    :alt: Commits since latest release
    :target: https://github.com/Ouranosinc/cowbird/compare/0.4.1...master

.. |version| image:: https://img.shields.io/badge/tag-0.4.1-blue.svg?style=flat
    :alt: Latest Tag
    :target: https://github.com/Ouranosinc/cowbird/tree/0.4.1
...
.. |github_tagged| image:: https://img.shields.io/github/workflow/status/Ouranosinc/cowbird/Tests/0.4.1?label=0.4.1
...
.. |cowbird_tag_base| replace:: pavics/cowbird:0.4.1
.. _cowbird_tag_base: https://hub.docker.com/r/pavics/cowbird/tags?page=1&ordering=last_updated&name=0.4.1
.. |cowbird_tag_worker| replace:: pavics/cowbird:0.4.1-worker
.. _cowbird_tag_worker: https://hub.docker.com/r/pavics/cowbird/tags?page=1&ordering=last_updated&name=0.4.1-worker
.. |cowbird_tag_websvc| replace:: pavics/cowbird:0.4.1-webservice
.. _cowbird_tag_websvc: https://hub.docker.com/r/pavics/cowbird/tags?page=1&ordering=last_updated&name=0.4.1-webservice
