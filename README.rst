...
.. |commits-since| image:: https://img.shields.io/github/commits-since/Ouranosinc/cowbird/2.7.0.svg
    :alt: Commits since latest release
    :target: https://github.com/Ouranosinc/cowbird/compare/2.7.0...master

.. |version| image:: https://img.shields.io/badge/tag-2.7.0-blue.svg?style=flat
    :alt: Latest Tag
    :target: https://github.com/Ouranosinc/cowbird/tree/2.7.0
...
.. |github_tagged| image:: https://img.shields.io/github/actions/workflow/status/Ouranosinc/cowbird/tests.yml?label=2.7.0&branch=2.7.0
...
.. |cowbird_tag_base| replace:: pavics/cowbird:2.7.0
.. _cowbird_tag_base: https://hub.docker.com/r/pavics/cowbird/tags?page=1&ordering=last_updated&name=2.7.0
.. |cowbird_tag_worker| replace:: pavics/cowbird:2.7.0-worker
.. _cowbird_tag_worker: https://hub.docker.com/r/pavics/cowbird/tags?page=1&ordering=last_updated&name=2.7.0-worker
.. |cowbird_tag_websvc| replace:: pavics/cowbird:2.7.0-webservice
.. _cowbird_tag_websvc: https://hub.docker.com/r/pavics/cowbird/tags?page=1&ordering=last_updated&name=2.7.0-webservice
